...
uint256 hashGenesisBlock("0x000003899d2b79d9d37ad43b635a105cef0569f3d17265ad36be238848242e92");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // JejuCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "JejuCoin Signed Message:\n";
...
{
    // JejuCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    // JejuCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
	...
	//  
		...
		const char* pszTimestamp = "jjc genesis block";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1481079655;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2763673;
        ...
        assert(block.hashMerkleRoot == uint256("0x4183c097ac7db9e03b9ce21f6f7add8bfe798124ff4f9bf5eacdb61cada82417"));
...
unsigned char pchMessageStart[4] = { 0xf6, 0xc7, 0xb9, 0xde }; // JejuCoin: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("JejuCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("JejuCoinMiner : ProcessBlock, block not accepted");
    }
